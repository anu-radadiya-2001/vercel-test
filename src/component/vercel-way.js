...
const vercelway = () => {
  return (
    <div className="">
      <div className="text-center lg:pt-0 pt-10">
      ...
      <div className="mx-auto justify-center items-center flex flex-col mt-8 px-6">
        ...
        <span className="develop-text text-[32px] font-bold my-6">Develop</span>
        <h2 className="md:text-6xl text-[40px] font-bold text-center leading-tight">Build when inspiration strikes</h2>
        <p className="max-w-[640px] text-[#666666] dark:text-[#a1a1a1] text-center mt-8 text-xl">
