...
import Sveltekiticon from "../assets/images/svelte.svg";
  ...
  return (
    <div className="pt-24 mx-auto">
      ...
      <div className="flex gap-8 w-full mx-auto max-w-[1060px] mt-12 md:flex-row flex-col px-6">
        ...
        <div className="lg:max-w-[520px] w-full max-w-[520px] mx-auto dark:border-[#333] p-6 rounded-lg shadow-[0_8px_30px_rgba(0,0,0,.12)] dark:bg-[#111] bg-[#fafafa]">
          ...
          <div className="grid grid-cols-2 gap-4 items-center justify-center flex-wrap mb-6">
              ...
              <div className="bg-white w-full p-3 shadow-[0_5px_10px_rgba(0,0,0,.12)] border dark:border-[#333] rounded-b-md dark:bg-black">
                <div className="flex gap-4 items-center">
                  <Image
                    src={Nexticon}
                    alt="next"
                    className="relative w-5 h-5 dark:invert"
                  />
            ...
            <a href="#0" className="text-[#444444] dark:text-[#999999] text-sm relative block md:text-left text-center">
