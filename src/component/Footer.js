      ...
      <div className="max-w-[1200px] w-full mx-auto py-16">
        <div className="flex md:flex-row sm:flex-col flex-col">
          <div className="max-w-[100%] w-full flex flex-col md:justify-start items-start">
            ...
            <div className="flex mt-10 items-center hover:bg-[#eaeaea] py-1 px-[6px] rounded-lg text-sm">
              <span>Status:</span>
              ...
              {Company.map((item) => (
                <li key={item.id} className="list-none py-2 px-3 flex gap-1 items-center leading-none">
                  ...
                  >
                    ...
                    {item.icon &&
                     <div className="">
                    <div onClick={() => setLegal(!legal)} className="block cursor-pointer">
                      <Image src={item.icon} alt="" className="w-5 dark:invert"/>                   
                    </div>
                    <div className={`${legal ? 'block' : 'hidden' } text-[#171717] dark:text-white dark:border-[#333] dark:bg-[#0a0a0a] absolute border border-[#eaeaea] max-w-[230px] bottom-8 w-full bg-white text-sm rounded-xl p-2`}>
                      <div>
                ...
                {item.img &&
                 <Image src={item.img} alt="" className="w-4 dark:invert opacity-50"/>        
                }
                </li>
              ))}
            </FooterData>
          ...
          <div className="flex justify-between mt-4 items-center md:flex-row flex-col">
            ...
            <div className="flex border border-[#d0cfcf] dark:border-[#ffffff24] rounded-full py-[3px] px-1 mt-5 sm:mt-6 md:mt-0">
              ...
              <button className="w-8">
                <Image src={desktop} alt="desktop" className="mx-auto dark:invert" />
              </button>
            </div>        
          </div>
        </div>
