...
const scroll = () => {
  return (
    <div className="bg-[#fafafa] dark:bg-[#111] border-y border-[#eaeaea] dark:border-[#333] mt-24 relative z-[99]">
      <div className="max-w-[1248px] mx-auto flex lg:p-8 md:p-6 p-5 grow flex-wrap flex-col md:flex-row">
