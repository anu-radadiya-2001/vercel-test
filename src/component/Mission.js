...
const Mission = () => {
  return (
    <div className='lg:min-h-[899px] sm:min-h-[780px] min-h-[694px] flex items-center justify-center flex-col h-full max-w-[1248px] mx-auto px-3 sm:px-0'>
      <div className=''>
        <div className='max-w-[953px] mx-auto text-center'>
          <p className='text-sm text-[#0070f3] uppercase tracking-[4.4px]'>Our Mission</p>
          <h2 className='lg:text-[56px] md:text-5xl text-[30px] font-bold lg:leading-[69px] md:leading-[58px] leading-[34px] mt-2 px-4'>We enable developers to build and
           publish wonderful things</h2>
        </div>
        <h5 className='sm:mt-10 mt-4 lg:mt-14 max-w-[570px] text-center font-normal lg:text-2xl sm:text-xl mx-auto'>We build products for <span className='font-bold'>developers and designers.</span> And those who aspire to become one.</h5>
      </div>
      <div className='flex lg:flex-row flex-col lg:mt-24 mt-16 lg:gap-6 gap-10'>
        <div className='flex flex-row gap-6 max-w-[310px] w-full'>
