  ...
  return (
    <>
      <div
        ...
        //   scrolled &&
        //   "lg:bg-white/80 bg-white dark:bg-black/60 dark:border-[#1a1a1a] border-b border-[#0000001A] sticky top-0 backdrop-blur-sm z-[999]"
        // }`}
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <li className="group relative text-center lg:inline-block block">
                    <button
                      type=""
                      className="items-center lg:justify-start justify-between w-full lg:py-2 py-4 px-3 lg:pr-6 gap-1.5 text-sm leading-none dark:text-[#A1A1A1] hover:dark:text-white lg:text-[#666666] text-[#171717] hover:text-[#171717] group-hover:lg:bg-[#0000001a] lg:rounded-full transition-all lg:border-none border-b border-[#00000014] lg:flex hidden dark:hover:bg-[#ffffff21] "
                    >
                      Features
                      <Image src={downArrow} alt="downArrow" className="w-[10px] dark:invert group-hover:rotate-180 transition-all group-hover:opacity-100 opacity-70" />
                    </button>
                    <HeaderData
                      title={"Features"}
                      ...
                      <div className="flex flex-wrap w-full p-1.5 bg-white cursor-pointer border border-[#ebebeb] rounded-xl shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12),0_30px_60px_-30px_rgba(0,0,0,0.15)] dark:bg-black dark:border-[#333] dark:bg-opacity-50">
                        {featuresList.map((item) => (
                          ...
                          >
                            ...
                            <p className="text-[#666666] dark:text-[#a1a1a1] text-start pt-2">{item.subtitle}</p>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {menuList.map((item) => (
                    ...
                    >
                      <Link
                        className="p-2 lg:py-2 py-4 text-sm leading-none lg:inline-block block dark:text-[#A1A1A1] hover:dark:text-white lg:text-[#666666] text-[#171717] hover:text-[#171717] transition-all capitalize lg:border-none border-b border-[#00000014] dark:border-[#333]"
                        href={item.url}
                      >
                        {item.name}
                      </Link>
                ...
                <div className="lg:hidden block w-7" onClick={MenuToggle}>
                  <div className="flex items-center justify-center w-8 h-8 border rounded-full dark:border-[#333]">
                    <Image
                      src={menuicon}
                      alt=""
                      className={`${menu ? "hidden" : "block"} dark:invert opacity-80`}
                    />
                    <Image
                      src={close}
                      alt=""
                      className={`${menu ? "block" : "hidden"} dark:invert opacity-80`}
                    />
                  </div>
                </div>
              </div>
